...
const Customiser = () => {
  ...
  const merchandise = [
    ...
    {
      name: "White Simple Mug",
      images: [
        "merch/mug/main.png",
        "merch/mug/front1.png",
        "merch/mug/handle.png",
      ],
      price: 2500,
    },
  ];
  ...
  const showFeatures = () => {
    ...
    if (features !== undefined) {
      return features.map((feature, i) => (
        <div
          class={"card mb-3 " + (selFeatureIndex === i ? "feature-active" : "")}
  ...
  const showSelImages = () => {
    if (selectedMerch !== null) {
      return selectedMerch.images.map((item, i) => (
        <div
          class={"card mb-3 " + (selImgIndex === i ? "feature-active" : "")}
          onClick={(e) => setObject(i)}
        >
          <div className="card-body">
